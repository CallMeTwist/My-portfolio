...
<?php include('Templates/headNloader.php'); ?>
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-10">
                        <div class="caption text-center">
                            ...
                            <h1 class="fz-55 mt-30"> Mastering Modern JavaScript: A Deep Dive into ES6+ Features</h1>
                        ...
                        <div class="cont">
                            <div class="text mb-20">
                                <div class="d-flex align-items-center mb-20">
                                    <span class="fz-60 fw-500 main-color line-height-1 mr-10 mb-25">J</span>
                                    <p>avaScript, the backbone of web development, has undergone a significant transformation with the introduction of ECMAScript 6 (ES6) and subsequent updates. These advancements bring powerful features that enhance the language's expressiveness, readability, and overall efficiency. </p>
                                </div>
